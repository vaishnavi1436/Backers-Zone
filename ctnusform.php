        ...
        <div class="col-xl-10 d-flex align-items-center justify-content-end">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li><a href="customizepg.php">Shops</a></li>
              <li><a href="ctnusform.php">Contact</a></li>
              <li><a href="#">Cart</a></li>
              <li><a href="#" type="button">Login/Signup</a></li>
             <div class="input-group" style="margin:auto;max-width:auto;background-color: #f5789e;float: right; width:auto;height: auto; border: #f5789e; border-radius: 50%;">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong" style="background-color: #f3a2bb;"><i class="bx bx-search"></i></button>
              </div>
